...
**"summarize changes"** — Don't just run `git status`. Run `git diff`, read every hunk, then:
...
**"explain the architecture"** — Don't just list directories. Read entry points, key types, module boundaries:
...
**"review this design"** — Think critically:
